...
- **Perform a [cursory search](https://github.com/search?q=user%3Akrishdevdb+is%3Aissue&type=issues)** to see if the problem has already been reported. If it has **and the issue is still open**, add a comment to the existing issue instead of opening a new one.

#### How Do I Submit A (Good) Bug Report?

Bugs are tracked as [GitHub issues](https://guides.github.com/features/issues/). Create an issue on this repository and provide the following information by filling in [the template](https://github.com/krishdevdb/.github/blob/main/.github/ISSUE_TEMPLATE/fix.md).
...
- **Perform a [cursory search](https://github.com/search?q=user%3Akrishdevdb+is%3Apr&type=issues)** to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
We follow the [conventional commits](https://www.conventionalcommits.org/) for our commit messages.
